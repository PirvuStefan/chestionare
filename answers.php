...
$chestionar = $S_SESSION['chestionar'] ?? null;

// nu prea mege sa folosesc $_SESSION pentru ca nu am voie sa o folosesc in acest fisier, deci trebuie sa o iau din cookie ???
